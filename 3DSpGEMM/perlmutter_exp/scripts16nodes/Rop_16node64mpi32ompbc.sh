...
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset euk --BC --1d --metisgp file,64
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset euk --BC --2d --randperm
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset euk --BC --3d 4,16 --randperm

srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset hv15r --BC --1d
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset hv15r --BC --2d --randperm
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset hv15r --BC --3d 4,16 --randperm
