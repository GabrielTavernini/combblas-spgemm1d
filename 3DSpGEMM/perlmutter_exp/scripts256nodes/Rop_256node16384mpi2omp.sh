...
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset $dataset --AA --Rop --2d --3d 4,16,64,256,1024 --randperm 
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset $dataset --AA --Rop --2d --3d 4,16,64,256,1024
