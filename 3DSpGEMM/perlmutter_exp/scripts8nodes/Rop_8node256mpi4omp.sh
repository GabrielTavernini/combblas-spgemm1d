...
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset $dataset --AA --Rop --1d --2d --3d 4,16,64
srun --cpu-bind=cores ./3DSpGEMM/Rop --dataset $dataset --AA --Rop --2d --3d 4,16,64 --randperm 
